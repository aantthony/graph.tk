...
renderers.push((function() {
    return (function(canvas, params) {
            ...
            "update": function(g, flags) {
                if (g) {
                    ...
                    if (flags.stopdchangeanimation && renderer.dchange) {
                        ...
                        if (!renderer.velocity && !renderer.animating) {
                            stopAnimation();
                        }
                    }
                }
        ...
        //Projection matrix
        gl.sMatrix = mat4.create();
        //Full screen square map matrix
        gl.nMatrix = mat3.create();
        //Normal matrix. I don't know how this works yet lol.
        ...
        function tick() {
            ...
            if (animating) {
                ...
                if (renderer.velocity) {
                    ...
                    renderer.cam_dist += renderer.velocity.z * deltat;
                }
                drawScene(deltat);
            }
            return res;
